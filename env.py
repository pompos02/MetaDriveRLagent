...
class MyEnvNoTraffic(MetaDriveEnv):
    ...
    def default_config(cls):
        ...
        config["map"] = "SSSSCSSXCSSCCCCCCSCSSCCCSSSSSSSCSSSSSSSCSSS"  # This enables procedural map generation
        config["start_seed"] = 0  # Ensures map variation
        ...
        config["crash_vehicle_penalty"]= 100.0
        config["crash_object_penalty"]= 100.0
        config["crash_building_penalty"]= 100.0
        config["out_of_road_penalty"]= 100.0
    ...
    def reward_function(self, vehicle_id: str):
        ...
        # Calculate heading difference with current lane
        heading_diff = vehicle.heading_diff(current_lane) - 0.5 # normalized for 0 to be straight


        # 5. Heading alignment reward
        heading_penalty = -abs(heading_diff) * 0.15
